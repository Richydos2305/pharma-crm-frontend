            ...
            <div className={`dropdown-panel${filterOpen ? ' open' : ''}`}>
              ...
              <div className="dropdown-options">
                {(Object.keys(AGE_LABELS) as AgeFilter[]).map((key) => (
                  <button
                    key={key}
                    className={`dropdown-option${pendingAge === key ? ' selected' : ''}`}
                    onClick={() => setPendingAge(key)}
                  >
            ...
            <div className={`dropdown-panel${sortOpen ? ' open' : ''}`}>
              ...
              <div className="dropdown-options">
                {(Object.keys(SORT_LABELS) as SortKey[]).map((key) => (
                  <button
                    key={key}
                    className={`dropdown-option${pendingSort === key ? ' selected' : ''}`}
              ...
              <div className="dropdown-footer">
                <button className="btn-ghost" onClick={clearSort}>Clear</button>
                <button className="btn-save" onClick={applySort}>Apply</button>
              </div>
            </div>
          </div>
        </div>
