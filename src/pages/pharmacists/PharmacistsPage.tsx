        ...
        <form onSubmit={handleSubmit}>
          <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="form-group" style={{ margin: 0 }}>
              <label className="form-label" htmlFor="ph-name">Full Name</label>
              <input
                id="ph-name"
            ...
            <div className="form-group" style={{ margin: 0 }}>
              <label className="form-label" htmlFor="ph-phone">Phone Number</label>
              <input
                id="ph-phone"
                className="form-input"
                type="tel"
...
export function PharmacistsPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, name, phoneNumber }: { id: string; name: string; phoneNumber?: string }) =>
      updatePharmacist(id, { name, phoneNumber }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['pharmacists'] });
      setEditTarget(null);
      setModalError('');
  ...
  return (
    <AppLayout mobileTopBar={mobileTopBar}>
      <div className="form-page-header">
        <h1 className="page-title" style={{ marginBottom: 0 }}>Pharmacists</h1>
        <button className="btn-primary" style={{ margin: 0 }} onClick={() => { setModalError(''); setAddOpen(true); }}>
          + Add Pharmacist
        </button>
      </div>
            ...
            <div className="pharmacist-card" key={ph.id}>
              ...
              <div className="pharmacist-card-bottom">
                ...
                <div className="pharmacist-actions">
                  <button className="btn-edit-pharm" onClick={() => { setModalError(''); setEditTarget(ph); }}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
